"""
Django settings for edison_example project.
...
SECRET_KEY = '^a*@(w$l)y_i6@)03_7_s3#c_@h%o1iy1022)^t@5_=tx*)7&a'
...
ROOT_URLCONF = 'edison_example.urls'
...
WSGI_APPLICATION = 'edison_example.wsgi.application'
